  ...
  return (
    <footer className="bg-white text-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contacts" className="text-black hover:text-brand-gold-light transition-colors">
                  <EditableText
              ...
              <li>
                <Link to="/documents/admissions" className="text-black hover:text-brand-gold-light transition-colors">
                  <EditableText
              ...
              <li>
                <Link to="/useful-links" className="text-black hover:text-brand-gold-light transition-colors">
                  <EditableText
              ...
              <li>
                <Link to="/gallery" className="text-black hover:text-brand-gold-light transition-colors">
                  <EditableText
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-300 text-center text-black">
