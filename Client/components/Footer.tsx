  ...
  return (
    <footer className="bg-brand-blue text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div>
            <EditableText
              ...
              className="text-lg font-semibold text-white mb-4"
            />
            <ul className="space-y-2 text-brand-gold-light">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contacts" className="text-brand-gold-light hover:text-white transition-colors">
                  <EditableText
              ...
              <li>
                <Link to="/documents/admissions" className="text-brand-gold-light hover:text-white transition-colors">
                  <EditableText
              ...
              <li>
                <Link to="/useful-links" className="text-brand-gold-light hover:text-white transition-colors">
                  <EditableText
              ...
              <li>
                <Link to="/gallery" className="text-brand-gold-light hover:text-white transition-colors">
                  <EditableText
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/20 text-center text-brand-gold-light">
          <p className="text-sm sm:text-base">
            &copy; {new Date().getFullYear()}{' '}
            <EditableText
              id="footer-copyright"
              defaultContent={getTranslation('footer.copyright', 'Kolyo Ganchev Elementary School. All rights reserved.')}
              tag="span"
            />
          </p>
          <p className="text-xs sm:text-sm mt-1">
            ...
            >
              <EditableText
                id="footer-design"
                defaultContent={getTranslation('footer.design', 'Tsa-soft')}
                tag="span"
